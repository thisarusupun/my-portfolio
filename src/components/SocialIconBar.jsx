            ...
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    {links.map(({ id, name, icon, link }) => (
                        <li key={id} className='w-[160px] h-[60px] flex justify-between items-center ml-[-110px] hover:ml-[5px] duration-300 bg-gradient-to-b from-gray-900 to-black shadow-md hover:shadow-gray-300 rounded-full my-2 px-4 pl-8'>
