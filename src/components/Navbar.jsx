...
function Navbar() {
    ...
    return (
        <div className='fixed w-full h-[50px] flex justify-between items-center px-4 bg-gradient-to-b from-gray-900 to-black text-gray-300'>
            ...
            <ul className='hidden md:flex'>
                {links.map(({ id, link }) => (
                    <li key={id} className='px-4 cursor-pointer capitalize font-medium to-gray-500 hover:scale-105 duration-200'>
